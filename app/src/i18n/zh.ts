...
export const zh: I18n = {
  ...
  cmd: {
    ...
    format: {
      markdown: '格式化 Markdown(Prettier)',
    },
    clean: {
      aiArtifacts: '清理 AI 痕迹(弯引号、长破折号、不可见字符)',
      stripMarkdown: '去除全部 Markdown 标记,转为纯文本',
    },
    export: {
      html: '导出为 HTML…',
      docx: '导出为 Word(DOCX)…',
      pdf: '导出为 PDF…',
      pdfPrint: '通过系统打印导出 PDF…',
      image: '导出为图片(PNG)…',
      epub: '导出为 EPUB…',
      odt: '导出为 ODT…',
      latex: '导出为 LaTeX…',
      rtf: '导出为 RTF…',
      pandocCustom: '通过 Pandoc 模板导出…',
      copyHtml: '复制为 HTML',
      copyPlain: '复制为纯文本',
      copyMd: '复制为 Markdown',
      copyImage: '复制为图片(PNG)',
    ...
    daily: {
      openTomorrow: '打开明天的日记',
      openYesterday: '打开昨天的日记',
      openToday: '打开今天的日记',
    },
    bases: {
      open: '工作区:属性表格(Bases)',
    ...
    history: {
      initWorkspace: '历史:初始化 Git 历史',
      commitNow: '历史:立即保存快照',
      toggleAutoGit: '历史:切换保存时自动提交',
    },
    sync: {
      pushNow: 'GitHub 同步:立即推送',
      pullNow: 'GitHub 同步:立即拉取',
      copyShareLink: 'GitHub 同步:复制本笔记分享链接',
    },
    note: {
      copyGitUrl: '复制笔记 Git 链接',
    },
    help: {
      welcomeTour: '打开欢迎导览',
      markdown: 'Markdown 速查表',
    },
    window: {
      new: '新建窗口',
    },
